...
//        grafo1.newArista(origin1, origin2,  2);
    ...
    private void initComponents() {
        ...
        Ruta.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel18.setText("Gestión de Rutas");
        Ruta.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, -1, -1));

        jLabel19.setText("Añadir Rutas:");
        Ruta.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, -1, -1));

        jLabel20.setText("Introduzca el nombre del almacen de la origen de la ruta:");
        Ruta.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, -1, -1));
        Ruta.add(origin_input3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 550, -1));

        jLabel21.setText("Introduzca el nombre del almacen que será el destino de la ruta:");
        Ruta.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, -1, -1));
        Ruta.add(destiny_input3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, 550, -1));

        jLabel22.setText("Introduzca la distancia entre los dos almacenes");
        Ruta.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, -1, -1));
        Ruta.add(weight_input3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 330, 550, -1));
        ...
        Ruta.add(insertarRuta, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 440, -1, -1));

        Parent.add(Ruta, "card4");
